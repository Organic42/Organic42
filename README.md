...
<img src="https://img.shields.io/badge/Status-Building-58a6ff?style=for-the-badge&logo=rocket&logoColor=white" />
...
currently:  Building an AI + dev studio from the ground up
fueled_by:  Lo-fi beats, hard problems, and good design
```

> I'm a builder who doesn't believe in picking a lane. One week it's a computer-vision pipeline,
> the next it's a real-time audio engine or a trade-finance workflow. **Curiosity is my stack.**
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Taking ideas from blank page to production. Architecture, systems design, UI/UX, infra — the whole pipeline.</p>
    </td>
    <td width="50%" valign="top">
      <h3>🤖 Applied AI / ML</h3>
